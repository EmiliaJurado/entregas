...
<body>
    <div class="brand">Pedidios y Entregas Emi</div>
    <div class="address-bar">Tu Móvil <strong>Directo</strong> y a la Puerta de tu Casa</div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Pedidios y Entregas Emi</a>
            </div>
    ...
    <div class="container">
            <div class="row">
                <div class="col">
                <img src="img/ocho.png" style="border-radius: 20px;"  alt="" width="387" height="300">
                <img src="img/nueve.jpg" style="border-radius: 20px;" alt="" width="387" height="300">
                <img src="img/diez.png" style="border-radius: 20px;"  alt="" width="387" height="300">
                </div>
            </div>
    </div>
    <br>
    ...
    <div class="container">
            <div class="row">
                <div class="col">
                <img src="img/siete.jpg" style="border-radius: 20px;"  alt="" width="387" height="300">
                <img src="img/cinco.jpg" style="border-radius: 20px;" alt="" width="387" height="300">
                <img src="img/seis.jpg" style="border-radius: 20px;"  alt="" width="387" height="300">
                </div>
            </div>
    </div>
    <br>
