...
<body>
    ...
    <div class="container">
			...
			<div class="row">
				<div class="box" style="border-radius: 10px;">
					<div class="col-lg-12">
						<hr>
						<h2 class="intro-text text-center"> Los TOP 5,4,3 <strong>Más</strong> Vendidos</h2>
						<hr>
					</div><br></br>
				</div>
			</div>
	...
	<script>
		...
		{	
			if(confirm("¿Está seguro de que desea agregar este producto a su carrito?") == true){
