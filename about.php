...
<body>
    ...
    <div class="address-bar">Tu Móvil <strong>Directo</strong> Y a la puerta de tu hogar</div>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Nosotros
                        <strong>Pedidos y Entregas Emi</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-6">
                    <img class="img-responsive img-border-left" src="img/paquete.jpeg" alt="">
                </div>
                <div class="col-md-6 text-justify">
                    <p>El servicio de pedidios y entregas Emi  es el que ofrecen las empresas para hacer las entregas a 
                    domicilio de los productos que los clientes compran vía online... Primero, la empresa
                    recibe el pedido, procesando la información del producto comprado, de la transacción y del cliente.</p>

                </div>
                <div class="col-md-6">
                    <img class="img-responsive img-border-left" src="img/pedido.jpeg" alt="">
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                   <p>
					...
					<?php if($Username == null){echo '<a href="Login.php?Role=User">Login</a>';} else {echo '<a href="Logout.php">Salir</a>';} ?> | 
